...
export class NBT_Byte extends NBT_Number {
    type = TAG_Byte;
}
export class NBT_Short extends NBT_Number {
    type = TAG_Short;
}
export class NBT_Int extends NBT_Number {
    type = TAG_Int;
}
export class NBT_Long extends NBT_Number {
    type = TAG_Long;
}
export class NBT_Float extends NBT_Number {
    type = TAG_Float;
}
export class NBT_Double extends NBT_Number {
    type = TAG_Double;
}
